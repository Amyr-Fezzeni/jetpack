...
class PdfService {
              ...
              children: [
                ...
                Center(
                  child: Container(
                      ...
                      child: Text(
                          'MANIFEST ${invoice.expeditorName}'.toUpperCase(),
        ...
        build: (context) => Column(
              ...
              children: [
                ...
                rowTxt(
                    ...
                    invoice.colis
                        .where((c) =>
                            [ColisStatus.delivered.name].contains(c.status))
                        .length
                        .toString()),
                rowTxt(
  ...
  static Future<void> generateColis(Colis colis) async {
    await requestPermission();
    final pdf = Document();
    final image = (await rootBundle.load(logo)).buffer.asUint8List();
    final fragileImage =
                  ...
                  data: [
                    [
                      SizedBox(
                        ...
                        width: 100,
                        child: BarcodeWidget(
                            data: colis.id, barcode: Barcode.codabar()),
                      ),
                      Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisSize: MainAxisSize.min,
                ...
                Container(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Spacer(),
                          rowTxt("A payer:",
                              '${colis.price.toStringAsFixed(3)} TND'),
                        ])),
                Container(
                    padding:
                        const EdgeInsets.symmetric(vertical: 10, horizontal: 5),
    ...
    final file = await saveDocument(
        name: "Colis ${getDate(colis.creationDate)}", pdf: pdf);
    openFile(file);
  }
